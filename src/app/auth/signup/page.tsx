      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-card shadow-card rounded-lg p-6 sm:p-8">
          ...
          <form className="space-y-6 sm:space-y-8" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-input-label mb-3">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
            ...
            <div className="text-center mt-6">
              <Link href="/auth/signin" className="text-blue-600 hover:text-blue-500 transition-colors duration-200">
